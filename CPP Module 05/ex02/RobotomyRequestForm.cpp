...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/26 15:02:48 by anmohamm          #+#    #+#             */
/*   Updated: 2024/06/26 15:02:48 by anmohamm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "RobotomyRequestForm.hpp"

RobotomyRequestForm::RobotomyRequestForm(const std::string& starget):AForm("RobotomyRequestForm", starget, 72, 45)
{
	std::cout<<"Robotomy Request Form constructor called"<<std::endl;
}

RobotomyRequestForm::RobotomyRequestForm(const RobotomyRequestForm& copy):AForm(copy.getName(), copy.getTarget(), copy.getSignGrade(), copy.getExecuteGrade())
{
