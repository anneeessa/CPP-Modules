...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/22 18:52:02 by anmohamm          #+#    #+#             */
/*   Updated: 2024/04/23 20:31:43 by anmohamm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int ac, char **av)
{
	...
	if (ac != 4)
	{
		std::cerr << "Try again with the correct format: ./sed filename str1 str2" << std::endl;
		exit (EXIT_FAILURE);
	}
	...
	if (!file.is_open())
	{
		std::cerr << "Invalid filename or No permission to access" << std::endl;
		file.close();
		exit (EXIT_FAILURE);
	}
	else
